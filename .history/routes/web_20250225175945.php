...
Route::get('/produtos', 'App\Http\Controllers\ProdutoController@lista')->name('produtos.lista');
Route::get('/produtos/{id}', [ProdutoController::class, 'mostra'])->name('produtos.mostra');
